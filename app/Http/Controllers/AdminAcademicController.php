...
class AdminAcademicController extends Controller
{
    ...
    public function storeMajor(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'acquired_skills' => 'nullable|array',
            'workplaces' => 'nullable|array',
            'in_demand_jobs' => 'nullable|array',
            'sustaining_skills' => 'nullable|array',
            'future_of_major' => 'nullable|string',
            'why_choose_major' => 'nullable|string',
            'when_not_suitable' => 'nullable|string',
            'global_opportunities' => 'nullable|string',
