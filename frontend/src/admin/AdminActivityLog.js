...
export default function AdminActivityLog({ setPage }) {
  ...
  return (
    <>
      ...
      <div className="admin-kpi-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 24 }}>
      ...
      <Card style={{ padding: 20, marginBottom: 24 }}>
         <div className="admin-filter-bar" style={{ display: 'flex', gap: 16, alignItems: 'center', flexWrap: 'wrap' }}>
